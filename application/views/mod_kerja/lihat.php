            ...
            <div id="content" data-url="<?= base_url('asst') ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="float-right"> 
                            ...
                            <a href="<?= base_url('mod_kerja/detail/'.basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING'])) ?>" class="btn btn-info btn-sm"><i class="fa fa-refresh "></i>&nbsp;&nbsp;Refres</a>
...
<div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td width="70"><strong><font size="2px">tanggal</font></strong></td>
                                             <td width="40"><strong><font size="2px">Id</font></strong></td>
                                            ...
                                            <td width="250"><strong><font size="2px">Chat</font></strong></td>
                                         <!--   <td width="50"><strong><font size="2px">File</font></strong></td>
                                                ...
                                                <td><font size="2px"><?= $no++ ?> </font></td>
                                                    ...
                                                    <td><font size="2px">
                                                         <?php
                                                            ...
                                                            ?>
                                                            <p style="font-size: 9px"><i> (<?php echo $row->department ?>)</i></p>
                                                           
                                                    </font>
                                                    </td>
                                                    <td > <?php $kode_pesan = $row->kode_create ?><font size="2px">
    <?php if ($kode_pesan == "TSKDT83657"):?>
    <div class="media-body" id="show_data_chatttt"> </div>
    ...
    setInterval(function(){
...
</script>  <?php endif;?> <!--   <?= $row->username ?>, <?= $row->chat ?> --> </br>
        ...
        <a href="<?php echo base_url('mod_kerja/detail_sub/'.$kode_pesan )?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Message New Tab</a>
    ...
    <?php endif; ?></font></td>
     <td><font size="2px"> <a  data-toggle="modal" style="color:white" data-target="#pesan_tambah_1<?= $row->id_dt_sub ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
        <a  href="<?= base_url('mod_kerja/detail_sub/' . $row->kode_create) ?>" target="blank"  class="btn btn-primary btn-sm"><i class="fa fa-envelope"><?php if(!empty($row->read_message OR $row->read_message_kontribut)):?><span class="badge badge-danger badge-counter">*</span><?php endif;?> Message</i></a></font></td> -->
    </tr>
...
<form action="<?= base_url('mod_kerja/update_berkas_detail_sub') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
...
<form method="post" action="<?= base_url('mod_kerja/save_berkas_detail_sub') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
      <div class="modal-body">
                                 <!-- Content Column -->
...
<div id="berkas_tambah" class="modal fade">
 ...
 <form method="post" action="<?= base_url('mod_kerja/save_berkas') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
        <div class="modal-body">
                                 <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
...
<script type="text/javascript">
    setInterval(function(){
        show_data_sub();   //pemanggilan fungsi tampil barang.
      ...
      //  $('#mydata').dataTable();
        ...
        function show_data_sub(){
            ...
            $.ajax({
                type  : 'post',
                url   : '<?php echo base_url()?>mod_kerja/data_sub_task',
                ...
                success : function(data){
                    ...
                    for(i=0; i<data.length; i++){ 
                        html += '<tr>';
                        html += '<td><font size="2px">'+data[i].tgl_created +'</font></td>';
                        html += '<td><font size="2px">'+data[i].status_task_sub +'</font></td>';
                        html += '<td><font size="2px">'+data[i].deskripsi_detail_sub +'</font></td>';
                        html += '<td><font size="2px">'+data[i].pembuat +'</font></td>';
                        html += '<td><font size="2px">'+'ada'+'</font></td>';
                        html += '<td><font size="2px">'+'ada'+'</font></td>';
                        html += '<td><font size="2px">'+'ada'+'</font></td>';
                        html += '</tr>';
